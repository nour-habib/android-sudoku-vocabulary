...
public class SudokuPuzzle {
	...
	public String [] getBoard() {
		...
		String [] flattenedArray = flattenArray(this.board);

		return flattenedArray;

	}

	public String[] getGame(int K)
	{
		int count = K;
		while (count != 0)
		{
...
//                j = j - 1;
		...
		String[] gameArray = flattenArray(this.board);
		return gameArray;
	}
	...
	private String[] flattenArray(String[][] arr2d)
	{
